...
class LLMsConfig:
    ...
    OPENAI_ENGINE = "gpt-4"  # Default engine for OpenAI requests
    ...
    BAFCLOUD_LLM_ENDPOINT = "https://api.bafcloud.com/api/v1/llms/generate"
    BAFCLOUD_PROJECT_KEY = os.getenv("BAFCLOUD_PROJECT_KEY")
    BAFCLOUD_PROJECT_ID = os.getenv("BAFCLOUD_PROJECT_ID")
